            ...
            .show(ui, |ui| {
                ...
                ui.horizontal(|ui| {
                    ...
                    ui.with_layout(egui::Layout::right_to_left(egui::Align::Center), |ui| {
                        ...
                        ui.add_sized(
                            [60.0, 24.0],
                            egui::Label::new(
                                egui::RichText::new(format!("{:.0}", settings.font_size))
                                    .size(13.0),
                            ),
                        );
                        ui.add_space(8.0);
                ...
                ui.horizontal(|ui| {
                    ...
                    ui.vertical(|ui| {
                        ...
                        ui.horizontal(|ui| {
                            let response = ui.checkbox(&mut settings.ui.show_status_bar, "");
                            if response.hovered() {
                                ui.ctx().set_cursor_icon(egui::CursorIcon::PointingHand);
                            }
                ...
                ui.horizontal(|ui| {
                    ui.vertical(|ui| {
                        ui.set_width(ui.available_width() / 2.0);
                        ui.horizontal(|ui| {
                            let response = ui.checkbox(&mut settings.ui.enable_animations, "");
                            if response.hovered() {
                                ui.ctx().set_cursor_icon(egui::CursorIcon::PointingHand);
                            }
                    ...
                    ui.vertical(|ui| {
                        ui.set_width(ui.available_width());
                        ui.horizontal(|ui| {
                            let response = ui.checkbox(&mut settings.ui.remember_sidebar_state, "");
                            if response.hovered() {
                                ui.ctx().set_cursor_icon(egui::CursorIcon::PointingHand);
                            }
                            ui.label(egui::RichText::new("Remember Sidebar State").size(14.0));
                        });
                    });
                });
                ...
                ui.horizontal(|ui| {
                    ...
                    ui.with_layout(egui::Layout::right_to_left(egui::Align::Center), |ui| {
                        ...
                        ui.add_sized(
                            [60.0, 24.0],
                            egui::Label::new(
                                egui::RichText::new(format!("{:.0}", settings.ui.sidebar_width))
                                    .size(13.0),
                            ),
                        );
                        ui.add_space(8.0);
                        ...
                        ui.add_sized(
                            [slider_width, 20.0],
                            egui::Slider::new(&mut settings.ui.sidebar_width, 200.0..=600.0)
                                .show_value(false),
                        );
                    });
                });
                ...
                ui.horizontal(|ui| {
                    ...
                    ui.with_layout(egui::Layout::right_to_left(egui::Align::Center), |ui| {
                        let dropdown_width = (ui.available_width() - 16.0).max(200.0).min(300.0);
