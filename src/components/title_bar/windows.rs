...
pub fn render_title_bar(ui: &mut egui::Ui, props: TitleBarProps<'_>) {
    ...
    let button_area_width = BUTTON_WIDTH * 3.0;
...
fn render_window_controls(ui: &mut egui::Ui, dark_mode: bool) {
    ...
    let close_hover_bg = egui::Color32::from_rgb(0xe8, 0x11, 0x23);
    ...
    let close_text = egui::RichText::new(egui_phosphor::regular::X)
        .size(10.0)
    ...
    ui.painter().rect_filled(maximize_rect, 0.0, maximize_bg);
    ...
    ui.painter().rect_filled(minimize_rect, 0.0, minimize_bg);
