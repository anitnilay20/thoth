...
use thoth_plugin_sdk::components::{
    Breadcrumbs, Button, ButtonColor, ButtonGroups, ButtonSize, ButtonType,
};
use thoth_plugin_sdk::theme::{THEME_MEMORY_ID, ThemeColors};
    ...
    fn ui(&mut self, ui: &mut egui::Ui, _frame: &mut eframe::Frame) {
        ...
        egui::Panel::left("stories")
            ...
            .show_inside(ui, |ui| {
                ...
                ui.separator();
                ui.selectable_value(&mut self.story, Story::Button, "Button");
                ui.selectable_value(&mut self.story, Story::ButtonGroup, "Button Group");
                ui.selectable_value(&mut self.story, Story::Breadcrumbs, "Breadcrumbs");
